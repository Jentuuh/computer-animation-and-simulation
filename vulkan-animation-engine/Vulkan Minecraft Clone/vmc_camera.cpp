...
namespace vmc {
	...
	*/
	void VmcCamera::setOrthographicProjection(
	...
	canonical view volume.
	*/
	void VmcCamera::setPerspectiveProjection(float fovy, float aspect, float near, float far) {
	...
	*/
	void VmcCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
	...
	*/
	void VmcCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
		setViewDirection(position, target - position, up);
	}

	void VmcCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
